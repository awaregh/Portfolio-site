  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[160px_1fr] gap-12">
        ...
        >
          <p className="text-[#e8e6e3] text-base leading-relaxed">
            Former IC / lead at B2B platforms. I work end-to-end: interaction
            models, design systems, perf profiling.
          </p>
          <p className="text-[#b6b1a8] text-base leading-relaxed">
          ...
          <p className="text-sm font-mono text-[#b6b1a8] border-l-2 border-[#c4572f] pl-4 leading-relaxed">

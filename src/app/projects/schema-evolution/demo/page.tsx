...
import SchemaEvolutionEmbed from "@/components/demos/SchemaEvolutionEmbed";

export default function SchemaEvolutionDemoPage() {
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#0a0a0a]">
      <div className="max-w-5xl mx-auto">
        <Link
          href="/projects/schema-evolution"
        ...
        <div className="mb-8">
          ...
          <p className="text-[#888888] text-sm leading-relaxed max-w-xl">
            Run schema migration scenarios across a 3-service microservices architecture and observe
            backward-compatibility patterns in action.
          </p>
        </div>

        <SchemaEvolutionEmbed />
      </div>
    </div>
  );
}

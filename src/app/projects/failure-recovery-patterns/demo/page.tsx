...
import FailureRecoveryEmbed from "@/components/demos/FailureRecoveryEmbed";

export default function FailureRecoveryDemoPage() {
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#f0f7ff]">
      <div className="max-w-5xl mx-auto">
        <Link
          href="/projects/failure-recovery-patterns"
        ...
        <div className="mb-8">
          ...
          <p className="text-[#57789a] text-sm leading-relaxed max-w-xl">
            Inject failures to trip circuit breakers, observe state transitions, and watch recovery
            through half-open probes.
          </p>
        </div>

        <FailureRecoveryEmbed />
      </div>
    </div>
  );
}

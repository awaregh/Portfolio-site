...
import LLMGatewayEmbed from "@/components/demos/LLMGatewayEmbed";

export default function LLMGatewayDemoPage() {
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#f0f7ff]">
      <div className="max-w-5xl mx-auto">
        <Link
          href="/projects/llm-gateway"
        ...
        <div className="mb-8">
          ...
          <p className="text-[#57789a] text-sm leading-relaxed max-w-xl">
            Route requests across multiple LLM providers and compare cost, latency, and availability

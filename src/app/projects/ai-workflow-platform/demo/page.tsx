  ...
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#f0f7ff]">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/projects/ai-workflow-platform"
        ...
        <div className="mb-8">
          ...
          <p className="text-[#57789a] text-sm leading-relaxed max-w-xl">
            Select a workflow template, then press <strong className="text-[#1a2f45]">Run</strong> to watch
            each step execute in real time — just like the production system.
          </p>
        </div>

      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          ...
          {currentProject?.repoPath && (
            <a
              href={`https://github.com/awaregh/Portfolio-site/tree/main/${currentProject.repoPath}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#ffffff08] text-[#ededed] text-sm font-medium hover:bg-[#ffffff12] transition-colors border border-[rgba(255,255,255,0.08)] mb-6"
            >

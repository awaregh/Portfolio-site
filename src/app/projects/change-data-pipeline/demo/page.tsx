...
import ChangeDataPipelineEmbed from "@/components/demos/ChangeDataPipelineEmbed";

export default function ChangeDataPipelineDemoPage() {
  return (
    <div className="min-h-screen pt-24 pb-24 px-6 bg-[#f0f7ff]">
      <div className="max-w-5xl mx-auto">
        <Link
          href="/projects/change-data-pipeline"
        ...
        <div className="mb-8">
          ...
          <p className="text-[#57789a] text-sm leading-relaxed max-w-xl">
            Start the CDC pipeline to watch database mutations stream into the event log and sync
            across consumers in real time.
          </p>
        </div>

        <ChangeDataPipelineEmbed />
      </div>
    </div>
  );
}
